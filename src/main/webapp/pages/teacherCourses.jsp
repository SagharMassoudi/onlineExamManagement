...
<table align="center">
    ...
    <c:forEach items="${courses}" var="course">
        <tr>
            <form:form action="/showCourseExams" modelAttribute="course" method="get">
                <input type="hidden" id="emailAddress" name="emailAddress" value="${emailAddress}">

                <td><form:input cssClass="inputContainer" path="title" name="title" id="title"
                                value="${course.title}" readonly="true"/>
                </td>

                <td><form:input cssClass="inputContainer" path="classification" name="classification"
