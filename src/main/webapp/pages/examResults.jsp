...
<table>
    ...
    <tr>
        <form:form method="get" action="/getUnCheckedEssayQuestion">
            <input name="studentEmail" id="studentEmail" value="${studentScoreMap.key.emailAddress}" hidden>
            ...
            <td>
                <button type="submit" title="Start Correcting">
                    <i class="material-icons" style="font-size: 15px">spellcheck</i>
                </button>
            </td>
        </form:form>
    </tr>
